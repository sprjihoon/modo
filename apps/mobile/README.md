...
| 버전 | `pubspec.yaml` → `1.0.3+30` (다음 맥북 빌드) · 스토어에 올린 코드는 `+29` |
| 최근 UX | 가격안내 순서를 웹과 동일하게 · 고객 수치(`detail`) 견적 포함 · 친구초대 공유 |
| AAB | `build/app/outputs/bundle/release/app-release.aab` · 백업 `~/Documents/modo-android-signing/app-release-1.0.3+30.aab` |
...
| 최신 업로드 | **`1.0.3 (29)`** 판매 중. 다음 맥북 빌드는 **30** (가격안내 순서) |
