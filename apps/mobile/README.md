...
| 현재 트랙 | 비공개 테스트(Alpha) — **`28 (1.0.3)` 테스터 제공** · **`35 (1.0.5)` AAB 준비** · 프로덕션 액세스는 신청 검토 중 (2026-08-28) |
| 버전 | `pubspec.yaml` → `1.0.5+35` · Alpha 테스터는 아직 28 |
| 최근 UX | 고객 리뷰 · 홈 순서(주문 후 리뷰) · 배너 200 · 앱 가입 복구 |
| AAB | `build/app/outputs/bundle/release/app-release.aab` · 백업 `~/Documents/modo-android-signing/app-release-1.0.5+35.aab` |
