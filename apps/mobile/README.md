...
| 버전 | `pubspec.yaml` → `1.0.2+27` (다음 업로드) · 스토어 최신은 `+25` |
| 최근 UX | 고객 수치(`detail`) 견적 포함 · 치수 가이드 스크롤 · 업데이트 안내 · 알림 설정 이동 |
| AAB | `build/app/outputs/bundle/release/app-release.aab` · 백업 `~/Documents/modo-android-signing/app-release-1.0.2+27.aab` |
...
| 최신 업로드 | **`1.0.2 (25)`** 심사 대기. 다음 맥북 빌드는 **27** (고객 수치 저장) |
| App Store | **판매 중 `1.0` 빌드 21** · `1.0.2` 빌드 **25** **Waiting for Review** · https://apps.apple.com/kr/app/모두의수선/id6759492888 |
