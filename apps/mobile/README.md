...
iOS는 **1.0.6 판매 중** · **1.0.7 / 44 `WAITING_FOR_REVIEW`**(43 취소). Play는 **38 게시** · **44 AAB 백업**(`~/Documents/modo-android-signing/app-release-1.0.7+44.aab`, Play Console에 직접 업로드). 어드민 `app_versions`는 지금 iOS/Android 모두 **`1.0.5`**. 양쪽 `1.0.6` 판매 중이라 최신은 **`1.0.6`까지** 올려도 된다. **`1.0.7`은 양쪽 판매 뒤에만.**
...
| 최신 업로드 | **`1.0.6` 판매 중**. **`1.0.7 (44)` `WAITING_FOR_REVIEW`** |
