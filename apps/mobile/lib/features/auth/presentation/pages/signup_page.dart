...
class _SignupPageState extends ConsumerState<SignupPage>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!mounted) return;
      final code = normalizeInviteCode(
  ...
  Future<void> _handleSignup() async {
    ...
    try {
      ...
      await stashInviteCode(_inviteController.text);
      try {
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  onChanged: (value) {
                    final next = normalizeInviteCode(value);
                    if (value != next) {
                ...
                Text(
                  '친구가 알려준 초대 코드가 있으면 입력해주세요. 간편가입에도 적용됩니다.',
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                      onPressed: () {
                        context.go(loginPathWithInvite(_inviteController.text));
                      },
                      child: const Text(
                        '로그인',
                        style: TextStyle(
