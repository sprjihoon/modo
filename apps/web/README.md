...
> **최종 업데이트:** 2026-08-31 — 그랜드 오픈 홈 팝업 · Play `/download` 링크. `modo.io.kr` 라이브.
...
| 리뷰 쓰기 | ✅ | 배송완료 주문, 승인 후 공개. 홈·목록은 DB만. 수정·삭제는 마이페이지 |
| 친구 초대 | ✅ | `/signup`에서 초대 코드. 로그인 화면에는 없음 |
...
| 앱 다운로드 배너 | ✅ | 상단 고정 |
| 홈 팝업 | ✅ | `popups` · 지금 그랜드 오픈. CTA「수선」→ `/order/new`, 「앱」→ `/download` |
| 하단 탭바 | ✅ | 홈/주문/프로필 |
...
| 기능 | 모바일 앱 | 웹 |
|------|----------|-----|
| 리뷰 작성 | ✅ (`1.0.5` 판매 중 · 가이드·세부항목은 `1.0.6+37`) | ✅ |
| 쿠폰 사용 | ✅ | ⚠️ UI만 |
| 친구 초대 | ✅ | ❌ |
| 알림 (Push) | ✅ | ❌ (웹은 불가) |
| 홈 팝업 (`popups`) | ✅ | ✅ |
