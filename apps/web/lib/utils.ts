...
export function getAppStoreUrl(): string {
  ...
  return getAppDownloadHref(navigator.userAgent);
}

export function openInApp(_fallbackPath?: string) {
  const href = getAppDownloadHref(
    typeof navigator === "undefined" ? "" : navigator.userAgent
  );
  window.location.href = href.startsWith("http") ? href : APP_DOWNLOAD_PATH;
}
