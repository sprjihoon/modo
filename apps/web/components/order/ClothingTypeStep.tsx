...
const DEFAULT_CATEGORIES: Category[] = [
  { id: "1", name: "?∞ÏÖîÏ∏?Îß®Ìà¨Îß?, icon_name: "tshirt" },
  { id: "2", name: "?îÏ∏†/Î∏îÎùº?∞Ïä§", icon_name: "shirt" },
  { id: "3", name: "?êÌîº??, icon_name: "dress" },
  { id: "4", name: "Î∞îÏ?", icon_name: "pants" },
  { id: "5", name: "Ï≤?∞îÏßÄ", icon_name: "jeans" },
  { id: "6", name: "ÏπòÎßà", icon_name: "skirt" },
  { id: "7", name: "?ÑÏö∞??, icon_name: "outer" },
  { id: "8", name: "?ïÏû•/?òÌä∏", icon_name: "suit" },
];
