...
const KR_HOLIDAYS = new Set([
  ...
  "2026-05-05", "2026-05-24", "2026-05-25", // 어린이날, 부처님오신날+대체(일→월)
  "2026-06-06",
  "2026-08-15", "2026-08-16", "2026-08-17", // 광복절+대체(토→월)
  "2026-09-24", "2026-09-25", "2026-09-26", "2026-09-28", // 추석연휴+대체(토→월)
