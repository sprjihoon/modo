...
| iOS 심사 상태 | **WAITING_FOR_REVIEW** · 심사 빌드 **1.0.0 (9)** (MinOS 15) — 2026-08-10 재제출 완료 |
...
| App Store 다음 빌드 | ~~+9 IPA 업로드·심사 빌드 교체·재제출 완료~~ · Apple 심사 대기 |
...
10. ~~ITMS-90068 / 빌드 9 업로드·심사 재제출~~ · **대기:** Apple 심사 · Play Alpha `1.0.0 (9)` AAB 게시
