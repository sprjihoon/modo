...
**오늘(2026-09-02):** 스토어 빌드 `1.0.7+46` 재제출. 45 심사 취소. 수선 수치는 숫자만. 웹 결제 푸터는 접힌 아코디언.
...
45. **`1.0.7+46` 수선 수치 숫자만** — 부호·소수점 불가. 웹 결제 푸터는 접힌 아코디언. 45 심사 교체
...
| 9 | 접속 경로 캠페인 | 네이버/인스타/구글·UTM별 접속·결제. **2~4주 데이터 쌓인 뒤** | 대기 | |

### 보류

가입 첫 유입 저장, 배너 노출수, 광고 ROAS. 수집을 새로 넣거나 UTM이 더 쌓여야 해서 P0~P1 다음에 한다.
