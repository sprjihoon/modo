...
| 날짜 | 항목 | 내용 |
|---|---|---|
| 2026-09-01 | 프로모션 코드 저장·성적 | 어드민 생성이 RLS에 막히던 문제. `/api/admin/promotions`로 저장. 관리 화면과 쿠폰 성적표가 같은 `promotion_codes` 목록. 사용·매출은 결제된 주문 기준. 포인트 전액·0원 주문에도 사용 이력 기록. 어드민·웹 라이브 |
