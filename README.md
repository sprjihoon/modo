...
PC(`lg`+)에서는 중앙 앱(600px) **양옆 여백**에 위젯을 띄웁니다. 이용 방법은 루트 레이아웃에 마운트되어 메인 포함 전 페이지에 표시됩니다.
...
| 오른쪽 | 이용 방법 | **메인·전 페이지** PC 상시 (`OrderHowToSideWidget`, 아코디언) — **원하는 날짜에 우체국택배 방문 수거** 강조 |
