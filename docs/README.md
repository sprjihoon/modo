...
- 스토어 버전/출시 상태: 루트 [`README.md`](../README.md) 「앱스토어 / Play 출시 준비」 (`1.0.8+49` 코드, iOS `1.0.7` 판매 중 · `1.0.8` 49 제출 · Play `1.0.7 (46)` 게시 · AAB 49, MinOS 15). **웹은 `main` 즉시 배포**. 스토어 빌드는 하루 1회 · 맥북에서만
