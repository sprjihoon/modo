...
- 스토어 버전/출시 상태: 루트 [`README.md`](../README.md) 「앱스토어 / Play 출시 준비」 (`1.0.7+45`, iOS `1.0.6` 판매 중 · `1.0.7` 45 `WAITING_FOR_REVIEW` · Play 38 게시 · 45 AAB 백업, MinOS 15). **웹은 `main` 즉시 배포**. 스토어 빌드는 하루 1회 · 맥북에서만
