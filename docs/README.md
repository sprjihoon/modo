...
- 스토어 버전/출시 상태: 루트 [`README.md`](../README.md) 「앱스토어 / Play 출시 준비」 (`1.0.6+42`, iOS `1.0.5` 판매 중 · `1.0.6` 42 심사 대기 · Play 38 게시 · 42 검토 대기, MinOS 15). **스토어 빌드는 하루 1회 · 맥북에서만**. 오늘은 몇 시간 뒤 예정
